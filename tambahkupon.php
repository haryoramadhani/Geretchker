...
<body style="background-color: rgb(237, 236, 251);">
	...
	<form action="" method="post">
		...
		<div style="margin-left: 20px;" class="card-body">
				...
				<input style="width: 280px;" type="text" name="no_undian" id="no_undian" required>
                 <br>
				
				<label for="tgl_undian">tgl_undian :</label>
				<input style="width: 280px;" type="text" name="tgl_undian" id="tgl_undian">
			
				<label for="jenis_hadiah">jenis_hadiah:</label>
				<input style="width: 280px;" type="text" name="jenis_hadiah" id="jenis_hadiah">
					
				<br>
				<br>
				<button class="btn btn-secondary text-light" style="margin-left: 115px;" type="submit" name="submit3">Submit</button>
		</div>
