...
$member = query1("SELECT * FROM member");
 
 if(isset($_POST["cari1"]))
 {
 	$member = cari1($_POST["keyword1"]);
 }
 ?>
...
<body style="background-color: rgb(237, 236, 251);">
  ...
  <nav class="navbar navbar-dark bg-secondary">
      ...
      <div><form class="form-inline" style=" margin-top: -50px; margin-left: 910px;" action="" method="post">
		<input class="form-control mr-sm-2" type="text" name="keyword1" size="40" autofocus placeholder="masukkan keyword pencarian.." autocomplete="off" id="keyword1">
		<button id="tombol-cari" class="btn btn-outline-light my-2 my-sm-0" type="submit" name="cari1"><img src="svg/baseline-search-24px.svg"/></button>
	</form></div>
      <div style="margin-left: -20px;" class="dropdown-menu bg-secondary text">
        ...
        <p style="margin-left: 30px;"><img src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"></p>
          <a style="margin-top: -20px;" class="dropdown-item text-light" href="tambahmember.php"><img style="" src="svg/outline-add_box-24px.svg"/>Input Member</a>
        <p style="margin-left: 30px;"><img src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"><img style="margin-left: -6px;" src="svg/baseline-more_horiz-24px.svg"></p>
	...
	<tr>
		...
		<td><a class="btn btn-primary" href="ubahmember.php?id_member=<?= $row["id_member"]; ?>"><img src="svg/baseline-update-24px.svg"/>ubah</a> <a class="btn btn-danger" href="hapusmember.php?id_member=<?= $row["id_member"]; ?>" onclick="return confirm('apakah anda yakin akan menghapus data tersebut?')"><img src="svg/baseline-delete_outline-24px.svg"/>hapus</a></td>
